...
export const Header = () => {
    return (
        <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
            ...
            <h3 className='text-2xl sm:text-3xl md:text-[2.5rem] mb-3 font-Ovo animate-slideUpFade'>
                Hi! I'm Pranith 👋
            </h3>
            <h1 className='text-4xl mb-2 sm:text-6xl lg:text-[66px] font-Ovo animate-slideUpFade2'> Frontend developer </h1>

            <p className='text-lg max-w-5xl mx-auto my-2 font-Ovo animate-slideUpFade sm:text-xl '>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4 animate-slideUpFade2'>
                <a href="#contact"
                    className='px-10 py-3 rounded-full  bg-black text-white flex items-center gap-2 hover:bg-blue-400 transition duration-500'
                >Contact me
